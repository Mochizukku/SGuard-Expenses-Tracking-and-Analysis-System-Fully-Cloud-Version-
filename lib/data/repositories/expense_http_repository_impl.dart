...
class ExpenseHttpRepositoryImpl implements ExpenseRepository {
  final HttpDatasource _datasource;

  ExpenseHttpRepositoryImpl(this._datasource);
  ...
  Stream<List<Expense>> streamUserExpenses(String userId) {
    // HTTP doesn't support streaming, use polling instead
    return Stream.periodic(const Duration(seconds: 5), (_) {
      return _datasource.pollUserExpenses(userId);
